...
keyword: 에러, SDK, 결제창, 결제창(구버전), 오류, error, failure, 에러 객체, AGREEMENT\_WIDGET\_ALREADY\_RENDERED, BELOW\_ZERO\_AMOUNT, COMMON\_ERROR, CUSTOM\_PAYMENT\_METHOD\_UNABLE\_TO\_PAY, DUPLICATED\_ORDER\_ID, EXCEED\_DEPOSIT\_AMOUNT\_LIMIT, EXCEED\_MAX\_DISCOUNT\_COUNT, EXCEED\_MAX\_DUE\_DATE, FAILED\_CARD\_COMPANY, FAILED\_DB\_PROCESSING, FAILED\_PAYMENT\_INTERNAL\_SYSTEM\_PROCESSING, FORBIDDEN\_DORMANT\_OR\_WITHDRAWAL\_CUSTOMER, INCORRECT\_FAIL\_URL\_FORMAT, INCORRECT\_SUCCESS\_URL\_FORMAT, INSECURE\_KEY\_USAGE, INVALID\_AMOUNT\_CURRENCY, INVALID\_AMOUNT\_VALUE, INVALID\_CARD\_INFO\_RE\_REGISTER, INVALID\_CARD\_LOST\_OR\_STOLEN, INVALID\_CLIENT\_KEY, INVALID\_CUSTOMER\_KEY, INVALID\_MAXIMUM\_DISCOUNT\_AMOUNT, INVALID\_METADATA, INVALID\_METHOD\_TRANSACTION, INVALID\_PARAMETER, INVALID\_PARAMETERS, INVALID\_PASSWORD, INVALID\_REQUEST, INVALID\_REQUIRED\_PARAM, INVALID\_SELECTOR, INVALID\_STOPPED\_CARD, INVALID\_VARIANT\_KEY, MAINTAINED\_METHOD, NEED\_AGREEMENT\_WITH\_REQUIRED\_TERMS, NEED\_AGREEMENT\_WITH\_TERMS, NEED\_CARD\_PAYMENT\_DETAIL, NEED\_MERCHANT\_ONE\_TOUCH\_SETTING, NEED\_REFUND\_ACCOUNT\_DETAIL, NETWORK\_ERROR, NOT\_ALLOWED\_BRANDPAY\_METHOD, NOT\_FOUND\_CUSTOMER, NOT\_FOUND\_MERCHANT, NOT\_FOUND\_METHOD, NOT\_FOUND\_METHOD\_OWNERSHIP, NOT\_FOUND\_PAYMENT, NOT\_REGISTERED\_REDIRECT\_URL, NOT\_SELECTED\_PAYMENT\_METHOD, NOT\_SETUP\_AMOUNT, NOT\_SUPPORTED\_API\_INDIVIDUAL\_KEY, NOT\_SUPPORTED\_METHOD, NOT\_SUPPORTED\_PROMISE, NOT\_SUPPORTED\_WIDGET\_KEY, NO\_ACTIVE\_PAYMENT\_REQUEST, PAYMENT\_METHODS\_WIDGET\_ALREADY\_RENDERED, PAYMENT\_REQUEST\_ABORTED, PAY\_PROCESS\_ABORTED, PAY\_PROCESS\_CANCELED, PROVIDER\_STATUS\_UNHEALTHY, REJECT\_CARD\_COMPANY, RESTRICTED\_TRANSFER\_ACCOUNT, SUSPECTED\_PHISHING\_PAYMENT, UNKNOWN, UNKNOWN\_PAYMENT\_ERROR, UNSUPPORTED\_TEST\_PHASE\_PAYMENT\_METHOD, USER\_CANCEL, V1\_METHOD\_NOT\_SUPPORTED
...
| `INSECURE_KEY_USAGE`                      | test\_gsk, live\_gsk로 시작하는 시크릿 키는 클라이언트 코드에 노출되면 안 됩니다. 구매자를 식별하는 customerKey 값을 사용해주세요. |
| `INVALID_METADATA`                        | 올바르지 않은 metadata 형식입니다.                                                                                                 |
| `NOT_SUPPORTED_API_INDIVIDUAL_KEY`        | 주문서형, 결제창형 연동 키의 클라이언트 키로 SDK를 연동해주세요. API 개별 연동 키는 지원하지 않습니다.                             |
| `NETWORK_ERROR`                           | 네트워크 에러가 발생했습니다. 잠시 후 다시 시도해주세요.                                                                           |
...
| `INSECURE_KEY_USAGE`              | test\_gsk, live\_gsk로 시작하는 시크릿 키는 클라이언트 코드에 노출되면 안 됩니다. 구매자를 식별하는 customerKey 값을 사용해주세요. |
| `INVALID_METADATA`                | 올바르지 않은 metadata 형식입니다.                                                                                                 |
| `NOT_SUPPORTED_WIDGET_KEY`        | API 개별 연동 키의 클라이언트 키로 SDK를 연동해주세요. 주문서형, 결제창형 연동 키는 지원하지 않습니다.                             |
| `NETWORK_ERROR`                   | 네트워크 에러가 발생했습니다. 잠시 후 다시 시도해주세요.                                                                           |
...
결제, 결제창의 `requestPayment()` 메서드로 결제 요청에 실패했을 때 `failUrl`로 전달되는 에러 목록입니다.
...
| `EXCEED_MAX_DISCOUNT_COUNT`                 | 즉시 할인이 가능한 횟수를 초과했습니다.                                                  | You have exceeded the number of times available for discount promotion.                                                       |
