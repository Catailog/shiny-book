  ...
  return (
    <>
      <section className="w-full">
        <div className="flex flex-col gap-10 px-6 py-16 sm:px-10 lg:flex-row lg:px-20 lg:py-20">
      ...
      <section className="w-full bg-secondary px-6 py-24 sm:px-10 lg:px-20">
          ...
          <div className="grid w-full grid-cols-1 gap-6 sm:grid-cols-3">
            {detail.specs.map((spec, index) => {
              ...
              return (
                ...
                >
                  {SpecIcon ? (
                    <SpecIcon aria-hidden="true" className="size-10 text-accent" />
                  ) : null}
