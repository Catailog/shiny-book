...
export const en = {
  ...
  consumer: {
    ...
    signup: {
      ...
      marketingEmailLabel: 'I agree to receive marketing emails.',
      marketingSmsLabel: 'I agree to receive marketing SMS.',
      agreeTermsLabel: "I agree to Shiny Book's Terms of Service and Privacy Policy.",
    ...
    orderNew: {
      ...
      productStep: {
        heading: '1. Select Product Type',
        premiumAlbum: 'Premium Album',
        premiumAlbumDescription: 'Finest faux leather with thick layflat printing',
        classicHardcover: 'Classic Hardcover',
        classicHardcoverDescription: 'Traditional smyth-sewn hardcover fabric binding',
        modernSoftcover: 'Modern Softcover',
        modernSoftcoverDescription: 'Light, sleek premium matte paper finish',
      },
      uploadStep: {
        heading: '2. Bulk Upload Manuscript / Images',
        dropzoneTitle: 'Bulk upload PDF and high-resolution images',
        dropzoneHint: 'Drag & drop or browse files (max 500MB)',
      },
      detailsStep: {
        heading: '3. Production Details',
        sizeLabel: 'Size',
        sizeValue: 'Selected: 10 x 10 in',
        paperLabel: 'Paper Type',
        paperValue: 'Selected: Fine Art Matte (default)',
        coverLabel: 'Cover Material / Finish Color',
        coverValue: 'Selected: Linen Charcoal + Gold Foil',
        notesLabel: 'Production Requests',
        notesPlaceholder:
          'Feel free to note pre-confirmation calls with the designer, cover engraving font changes, etc.',
      },
      summary: {
        title: 'Order Summary',
        basicProduct: 'Base product (Premium Album)',
        pageAddon: 'Extra pages (24p)',
        coverEmbossing: 'Cover foil embossing',
        shipping: 'Shipping',
        shippingFree: 'Free',
