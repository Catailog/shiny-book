  ...
  admin: {
    ...
    refunds: {
      ...
      review: {
        ...
        cancel: 'Close',
        approveConfirm: 'Approve and process',
        rejectConfirm: 'Reject',
        success: {
          approve: 'Refund approved and processed.',
          reject: 'Refund request rejected.',
          retry: 'Refund processing re-run.',
        },
        errors: {
          ...
          process_failed: 'Approved, but the payment cancellation failed. Please retry.',
    ...
    mypage: {
      ...
      orders: {
        ...
        refund: {
          ...
          cancel: 'Close',
          success: 'Your refund request has been received.',
          errors: {
            unauthorized: 'Please sign in.',
            validation_failed: 'Please check your input.',
            order_not_found: 'Order not found.',
            not_refundable: 'This order cannot be refunded in its current state.',
            already_open: 'There is already a refund request in progress.',
            amount_exceeds_remaining: 'The amount exceeds what can be refunded.',
            failed: 'The refund request failed. Please try again later.',
          },
        },
      },
    },
