  ...
  admin: {
    ...
    refunds: {
      ...
      review: {
        ...
        noteLabel: '메모 (선택)',
        cancel: '닫기',
        approveConfirm: '승인하고 처리',
        rejectConfirm: '거절',
        success: {
          approve: '환불을 승인하고 처리했습니다.',
          reject: '환불 요청을 거절했습니다.',
          retry: '환불 처리를 다시 실행했습니다.',
        },
        errors: {
          ...
          process_failed: '승인은 됐지만 결제 취소 처리에 실패했습니다. 재시도해주세요.',
          failed: '처리에 실패했습니다.',
        },
      },
    },
    ...
    mypage: {
      ...
      orders: {
        ...
        refund: {
          ...
          submitting: '요청 중...',
          cancel: '닫기',
          success: '환불 요청이 접수됐습니다.',
          errors: {
            unauthorized: '로그인이 필요합니다.',
            validation_failed: '입력값을 확인해주세요.',
            order_not_found: '주문을 찾을 수 없습니다.',
            not_refundable: '이 주문은 환불할 수 없는 상태입니다.',
            already_open: '이미 처리 중인 환불 요청이 있습니다.',
            amount_exceeds_remaining: '환불 가능 금액을 초과했습니다.',
            failed: '환불 요청에 실패했습니다. 잠시 후 다시 시도해주세요.',
          },
        },
      },
    },
