...
export const ko = {
  ...
  consumer: {
    ...
    signup: {
      ...
      phoneLabel: '전화번호 (선택)',
      marketingEmailLabel: '이메일 마케팅 정보 수신에 동의합니다.',
      marketingSmsLabel: 'SMS 마케팅 정보 수신에 동의합니다.',
      agreeTermsLabel: 'Shiny Book의 이용약관 및 개인정보 수집에 동의합니다.',
      submitButton: '계정 만들기',
      submitting: '가입 처리 중...',
    ...
    orderNew: {
      ...
      productStep: {
        ...
        premiumAlbumDescription: '최고급 인조가죽 및 두터운 레이플랫 인쇄',
        classicHardcover: 'Classic Hardcover',
        classicHardcoverDescription: '정통 사철 실 제본 방식 하드커버 패브릭',
        modernSoftcover: 'Modern Softcover',
        modernSoftcoverDescription: '가볍고 세련된 느낌의 고품질 매트 페이퍼',
      },
      uploadStep: {
        heading: '2. 원고 / 이미지 일괄 업로드',
        dropzoneTitle: 'PDF 및 고화질 이미지 일괄 업로드',
        dropzoneHint: '드래그 앤 드롭 또는 파일 탐색기 열기 (최대 500MB)',
      },
      detailsStep: {
        heading: '3. 제작 세부 옵션',
        sizeLabel: '사이즈',
        sizeValue: '선택: 10 x 10 in',
        paperLabel: '내지 종류',
        paperValue: '선택: Fine Art Matte (초기설정)',
        coverLabel: '커버 소재 / 가공 색상',
        coverValue: '선택: Linen Charcoal + Gold Foil',
        notesLabel: '제작 요청 사항',
        notesPlaceholder:
          '제작 전 디자이너 사전 컨펌 연락 요청, 커버 인그레이빙 서체 옵션 변경 등 자유롭게 적어주세요.',
      },
      summary: {
        title: '주문 요약',
        basicProduct: '기본 제품 (Premium Album)',
        pageAddon: '페이지 추가 (24p)',
        coverEmbossing: '커버 은박 가공',
        shipping: '배송비',
        shippingFree: '무료',
