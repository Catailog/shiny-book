...
export function Hero({ soldBookCount }: HeroProps) {
  ...
  return (
    <section className="w-full bg-background">
      <SiteContainer className="flex flex-col items-center gap-12 py-14 sm:py-20 lg:flex-row lg:gap-16 lg:py-24">
        <div className="flex flex-1 flex-col items-start gap-10">
          <div className="flex w-full flex-col items-start gap-4">
            <Badge className="bg-accent-soft text-accent rounded px-3 py-1.5 text-xs font-semibold tracking-wide">
              {hero.eyebrow}
            </Badge>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <Button
              ...
              nativeButton={false}
              variant="outline"
              className="h-auto rounded border-foreground bg-transparent px-7 py-3.5 text-foreground hover:bg-muted"
            >
        ...
        <div className="relative aspect-7/8 w-full shrink-0 overflow-hidden rounded-xl bg-secondary shadow-lg ring-1 ring-foreground/10 lg:w-135">
          <Image
